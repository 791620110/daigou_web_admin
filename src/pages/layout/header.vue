<template>
  <header class="main-header animated" :class="{closeLogo:sidebar.collapsed,mobileLogo:device.isMobile}">
    ...
    <!-- Logo -->
    <a href="#" class="logo">
      <span class="logo-lg">&nbsp;&nbsp; <b>云仓系统</b></span>
    </a>
    ...
    <nav class="navbar navbar-static-top">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown messages-menu" v-show="false">
...
<script>
  ...
  export default {
    ...
    methods: {
      ...
      logout(){
        this.$http.get(apiConfig.LOGOUT)
          .then(res => {
            this.setLogout();
            this.$http.defaults.headers.common['_token'] = '';
