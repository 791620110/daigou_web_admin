...
const reGenerationPDFButton = (vm, h, currentRow, index) =>{
  return h('Button', {
    style: {
      margin: '0 3px'
    },
...
const sendNoticeButton = (vm, h, currentRow, index) => {
  return h('Button', {
    style: {
      margin: '0 3px'
    },
                    ...
                    item.render = (h, param) => {
                        ...
                        if (item.handle.length === 3) {
                            return h('div', [
                                ...
                                //reGenerationPDFButton(this, h, currentRowData, param.index),
                                sendNoticeButton(this, h, currentRowData, param.index)
                            ]);
                            ...
                            if (item.handle[0] === 'edit') {
                                ...
                                return h('div', [
                                    deleteRow(this, h, currentRowData, param.index)
                                ]);
                            }
                        }
                    };
